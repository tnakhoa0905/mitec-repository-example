...
class ThCNOneScreen extends StatelessWidget {
  ThCNOneScreen({Key? key})
      : super(
          key: key,
        );
  ...
  TextEditingController printmenuoneController = TextEditingController();
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomTextFormField(
                controller: printmenuoneController,
                margin: EdgeInsets.only(
                  top: 16.v,
                  right: 2.h,
                ),
                hintText: "in thực đơn",
