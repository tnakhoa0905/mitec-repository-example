...
class DanhSChTiCOneScreen extends StatelessWidget {
  DanhSChTiCOneScreen({Key? key}) : super(key: key);
    ...
    return SafeArea(
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                centerTitle: true,
                title: AppbarSubtitle(text: "danh sách tiệc"),
                actions: [
                  AppbarSubtitle2(
                      text: "thêm",
                          ...
                          children: [
                            ...
                            Padding(
                                padding: EdgeInsets.only(
                                    left: 16.h, top: 4.v, bottom: 3.v),
                                child: Column(
                                    crossAxisAlignment:
                                        CrossAxisAlignment.start,
                                    children: [
                                      Text("khách a - 12/12/2023",
                                          style: theme.textTheme.titleSmall),
                                      SizedBox(height: 2.v),
                                      Text("mitec cầu giấy - sảnh 5 A - sáng",
